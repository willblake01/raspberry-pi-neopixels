...
export class AlternateCustomShiftPixel implements Effect {
  public leds: Options['leds'];
...
export class AlternateRandomShiftPixel implements Effect {
  public leds: Options['leds'];
  public interval: Options['interval'];
  private _red: Options['red'];
  private _green: Options['green'];
...
export class AlternateCustomShiftLoop implements Effect {
  public leds: Options['leds'];
  public interval: Options['interval'];
  public red: Options['red'];
  public green: Options['green'];
  ...
  loop() {
    ...
    // Set strand to color1 when unshifted and color2 when shifted
    for (let i = 0; i < this.leds; i++) {
      if (!this._isShifted) {
        pixels[i] = color1;
      } else {
...
export class AlternateRandomShiftLoop implements Effect {
  public leds: Options['leds'];
  public interval: Options['interval'];
  private _red: Options['red'];
  private _green: Options['green'];
